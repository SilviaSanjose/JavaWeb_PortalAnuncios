...
<div class="container my-5">
	...
	<form action="ServletListAdmin">
		<div class="form-row">
			...
			<div class="form-group col-md-4 d-flex align-items-end">	
				...
				<a href="ServletListAdmin" class="btn btn-secondary">Resetear</a>
			</div>
		</div>
	</form>
	...
	<!-- en test se pone lo que quieres comparar  -->
		...
		<a href="ServletListAdmin?begin=${previous}&article=${searchArticle}&id_category=${searchId_category}">Anterior</a>&nbsp;&nbsp;&nbsp;
		</c:if>
		<!-- en test se pone lo que quieres comparar  -->
		<c:if test="${next < total}">
		<a href="ServletListAdmin?begin=${next}&article=${searchArticle}&id_category=${searchId_category}">Siguiente</a>
		</c:if>
	</div>
					...
					<div class="card-body">		
						...
						<div class="card-text">
							<p>Categoría: ${ads.categoria.nombre}</p>
						 	...
						 	<a onclick="return confirm('Vas a borrar el artículo,¿estas seguro?')" href="ServletDelete?id=${ads.id}" 
						 			class="btn btn-secondary">Borrar</a>
							<a href="ServletEdit?id=${ads.id}" class="btn btn-secondary">Editar</a>
