...
/**
 * Servlet implementation class ServletListAdverts
 */
@WebServlet("/admin/ServletListAdmin")
public class ServletListAdmin extends HttpServlet {
	...
	//mando los datos al jsp	
		...
		RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/admin/listAdAdmin.jsp");
